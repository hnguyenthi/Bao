...
<template>
    <div>
            ...
            >
                ...
                >
                    ...
                    >
                        <Link
                            :href="item.link"
                            class="px-[10px] py-[5px] hover:underline hover:opacity-70"
                            :class="{
                                'decoration-primary hover:text-primary':
                                    item.isSlot,
                            }"
                        >
                            ...
                            <div
                                ...
                                "
                                class="align-center flex justify-items-center"
                            >
        ...
        <!-- mobile, tablet -->
        <div
            class="hamburger container relative mx-auto  flex h-[40px] items-center justify-between bg-white block md:hidden"
        >
            <div>
                <Link
                    href="top"
            ...
            <div class="text-[10px] text-primary">
                <div class="pr-[20px]">
                    <Link href="mypage?form=update-info">
                        <div>出茂 太郎様</div>
                        <div class="flex">
                            <span>スタンダード </span>
                            <span>
                ...
                <div
                    class="absolute right-[10px] top-[40px] z-50 w-[210px] w-full rounded-sm bg-secondary-100"
                    x-show="open"
                    ...
                    >
                        <div class="px-6">
                            <Link
                                ...
                                :href="item.link"
                                class="py-[6px] flex justify-center"
                            >
                                <div class="flex items-center pr-1" v-if="item.isSlot">
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
                                        width="14"
                                        height="14"
